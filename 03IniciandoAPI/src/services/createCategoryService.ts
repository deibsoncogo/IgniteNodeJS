...
import { CategoryRepository } from "../repositories/CategoryRepository"; // importação do repositório de categoria
...
class CreateCategoryService { // grupo único e principal
  constructor(private categoryRepository: CategoryRepository) {} // criar o acesso ao repositório

  execute({ name, description }: IRequest): CategoryModel { // função única e principal
